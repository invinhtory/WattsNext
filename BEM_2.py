...
# -*- coding: utf-8 -*-
"""
Created on Thu May 29 14:51:09 2025
...
def BEM(U_design, R, eta_0, B, r_hub, Re_design, lambda_design, aero_performance):   
    """
    Inputs:
    - U_design: Design wind speed [m/s]
    - B: Number of blades
    - R: Turbine radius [m]
    - r: Hub radius [m]
    - eta_0: balance of system efficiency [~]
    - lambda_design: Design tip speed ratio [~]
    - aero_performance: 
    """
    #Setup    
    # BEM discretization
    ...
    P_e = 0.5*rho*(U_design**3)*np.pi*(R**2)*eta_0*CP_turbine/1000
    print(f"Electrical Power Output: {P_e:.2f} kW")
    return CP, P_e, Re_blade
